...
| `expand_domain_ips` | `0` | `1` — домен, указывающий на несколько адресов, разворачивать в отдельный ключ на каждый IP. Доменный ключ остаётся. См. [Разворачивание доменов в IP](#разворачивание-доменов-в-ip). |
